...
const HorizontalNav = ()=>{
    return (
        <div className="w-full fixed inset-x-0 bottom-0 sm:hidden">
            <article className="border-x border-y border-gray-900 bg-white dark:bg-slate-900 dark:text-white p-2 hover:bg-gray-100 dark:hover:bg-slate-800">
                <div className=" mt-2">
                    <ul className="flex justify-around items-center flex-row">
                        <li className="">
                            <Link to={'/'}><a href="#" className="h-14 mx-auto w-14 p-3 hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center rounded-full"><span>
                        ...
                        <li className="mt-2"><a href="#"
                                className="h-14  w-14 p-3 mx-auto hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center rounded-full"><span>
                                    <svg viewBox="0 0 24 24" aria-hidden="true" className="w-9 h-8 fill-current">
                                        <g>
                                            <path
